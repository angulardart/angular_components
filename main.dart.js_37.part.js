...
if(d===C.V){x=w.x
return x==null?w.x=document:x}if(d===C.J)return w.gzJ()
if(d===C.b)return w.gmT()
if(d===C.P)return w.gzG()
if(d===C.N)return w.gqU()
if(d===C.a_)return w.gOE()
if(d===C.t)return w.gqV()
if(d===C.u)return w.gzL()
if(d===C.r)return w.gzM()
if(d===C.T)return w.gqW()
if(d===C.F)return w.gzN()
if(d===C.G){x=w.fx
return x==null?w.fx=C.Y:x}if(d===C.R)return w.gzI()
if(d===C.E)return w.gzK()
if(d===C.Q)return w.gzH()
...
if(d===C.n||d===C.j||d===C.c)return w.av}if(95<=e&&e<=96){if(d===C.m)return w.ar
if(d===C.n||d===C.j||d===C.c)return w.ah}if(101<=e&&e<=102){if(d===C.m)return w.af
if(d===C.n||d===C.j||d===C.c)return w.as}if(104<=e&&e<=105){if(d===C.m)return w.aA
if(d===C.n||d===C.j||d===C.c)return w.aM}if(116<=e&&e<=117){if(d===C.m)return w.aw
if(d===C.n||d===C.j||d===C.c)return w.aT}if(119<=e&&e<=120){if(d===C.m)return w.ba
if(d===C.n||d===C.j||d===C.c)return w.aF}if(125<=e&&e<=126){if(d===C.m)return w.aI
if(d===C.n||d===C.j||d===C.c)return w.b5}if(128<=e&&e<=129){if(d===C.m)return w.aG
...
if(s&&(v.av.cy=!0))v.aq.d.st(1)
if(s){x=v.ah
w=x.cy=x.r=!0}else w=!1
if(w)v.ai.d.st(1)
if(s&&(v.as.cy=!0))v.aj.d.st(1)
if(s){x=v.aM
w=x.cy=x.r=!0}else w=!1
if(w)v.ax.d.st(1)
if(s&&(v.aT.cy=!0))v.aB.d.st(1)
if(s&&(v.aF.cy=!0))v.aY.d.st(1)
if(s&&(v.b5.cy=!0))v.aR.d.st(1)
if(s&&(v.aJ.cy=!0))v.bb.d.st(1)
