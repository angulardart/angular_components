...
$__dart_deferred_initializers__.current=function(a,b,c,$){var C,H,J,P,W,G,Y,R,K,V,S,E={
aF7:function(){return new E.Sj(null,S.h(3,C.j,null))},
asW:function(){if($.ae4)return
$.ae4=!0
$.H.C(0,C.ns,C.dj)
E.A()
U.cZ()
...
_.c=_.b=_.a=_.a7=_.a9=_.a3=_.S=_.I=_.a_=_.a5=_.a1=_.Z=_.U=_.a4=_.V=null
_.d=d
_.e=e},
Sj:function Sj(d,e){var _=this
_.c=_.b=_.a=_.r=_.f=null
_.d=d
_.e=e}},M,Q,D,L,Z,O,B,A={fD:function fD(d){this.a=d},km:function km(){}},U,T={
akP:function(){return C.e5},
aF6:function(){return new T.Si(null,S.h(3,C.j,null))},
asV:function(){if($.ae2)return
$.ae2=!0
$.H.C(0,C.nr,C.e5)
E.A()
K.cu()
...
gyL:function(){var y=this.z
return y==null?this.z=window:y},
gmy:function(){var y,x=this,w=x.Q
if(w==null){w=x.d
y=x.e.z
y=T.b4(w.k(C.b,y),w.k(C.G,y),w.m(C.h,y),x.gyL())
x.Q=y
w=y}return w},
gyI:function(){var y,x=this,w=x.ch
if(w==null){w=x.d.m(C.Z,x.e.z)
y=x.gmy()
w=x.ch=new O.aH(w,y)}return w},
gqC:function(){var y=this,x=y.cx
return x==null?y.cx=new K.aM(y.gmx(),y.gmy(),P.b_(null,[P.q,P.j])):x},
gTB:function(){var y=this,x=y.cy
if(x==null){x=T.b7(y.d.m(C.h,y.e.z))
y.cy=x}return x},
gqD:function(){var y=this,x=y.db
if(x==null){x=G.bb(y.d.k(C.w,y.e.z))
y.db=x}return x},
gyN:function(){var y=this,x=y.dx
if(x==null){x=G.bd(y.gmx(),y.d.k(C.x,y.e.z))
y.dx=x}return x},
gyO:function(){var y=this,x=y.dy
if(x==null){x=G.b6(y.gqD(),y.gyN(),y.d.k(C.v,y.e.z))
y.dy=x}return x},
gqE:function(){var y=this.fr
return y==null?this.fr=!0:y},
gyP:function(){var y=this.fx
return y==null?this.fx=!0:y},
gyK:function(){var y=this.go
if(y==null){y=this.gmx()
y=this.go=new R.aK(y.querySelector("head"),y)}return y},
gyM:function(){var y=this.id
return y==null?this.id=X.ba():y},
gyJ:function(){var y=this,x=y.k1
return x==null?y.k1=K.b8(y.gyK(),y.gyO(),y.gqD(),y.gqC(),y.gmy(),y.gyI(),y.gqE(),y.gyP(),y.gyM()):x},
gTC:function(){var y,x,w,v,u=this,t=u.k2
if(t==null){t=u.d
y=u.e.z
x=t.m(C.h,y)
w=u.gqE()
...
if(d===C.a_){y=x.y
return y==null?x.y=document:y}if(d===C.M)return x.gyL()
if(d===C.b)return x.gmy()
if(d===C.T)return x.gyI()
if(d===C.R)return x.gqC()
if(d===C.a0)return x.gTB()
if(d===C.w)return x.gqD()
if(d===C.x)return x.gyN()
if(d===C.v)return x.gyO()
if(d===C.Y)return x.gqE()
if(d===C.I)return x.gyP()
if(d===C.J){y=x.fy
return y==null?x.fy=C.a3:y}if(d===C.W)return x.gyK()
if(d===C.H)return x.gyM()
if(d===C.V)return x.gyJ()
if(d===C.n)return x.gTC()
if(d===C.K){y=x.k3
return y==null?x.k3=C.a4:y}if(d===C.z){y=x.k4
return y==null?x.k4=new K.aS(x.gqC()):y}}return f},
q:function(){var y=this,x=y.b.a,w=y.r1
if(w!==x)y.r1=y.r.a=x
y.f.i()},
v:function(){this.f.j()}}
T.Si.prototype={
p:function(){var y,x,w,v=this,u=new T.KP(v,S.h(3,C.i,0)),t=$.a5i
if(t==null){t=new O.b3(null,C.a,"","","")
t.bB()
$.a5i=t}u.c=t
y=document.createElement("material-card-api")
u.a=y
v.f=u
u=H.a([new D.iN("README","angular_components/lib/material_card/README.md",X.f("<h1>Material Card</h1>\n<p>Material Card is card styling provided by the Google material team also known as\nmdc-web. This is a wrapper to allow the style to be used in AngularDart\napplications. For documentation on how to use these styling please see the <a href=\"https://github.com/material-components/material-components-web/tree/master/packages/mdc-card\">mdc\ndocumentation</a>. Examples can be found <a href=\"https://material-components.github.io/material-components-web-catalog/#/component/card\">here</a>.</p>\n<h2>Setup</h2>\n<p>The styles are provided by\n<code>package:angular_components/css/mdc_web/card/mdc-card.scss.css</code>. To use\nthese styles in an Angular component simply add it as a <code>styleUrls</code> value in\nyour <code>Component</code> annotation. We suggest that the style be added before any\ncomponent specific styling so you can easily override style values as needed.</p>\n<pre><code class=\"language-dart\">@Component(\n    selector: 'my-component',\n    templateUrl: 'my_component.html',\n    styleUrls: [\n      'package:angular_components/css/mdc_web/card/mdc-card.scss.css',\n      'my_component.scss.css'])\nclass MyComponent {}\n</code></pre>\n"))],[D.bO])
x=H.a([new R.aa(C.dj,"MaterialCardExample","material_card_example/lib/material_card_example.dart")],[R.aa])
w=P.j
w=new A.fD(R.c8(H.a([],[w]),x,u,P.aZ(["Material Spec","https://material.io/design/components/cards.html"],w,w),!0))
v.r=w
v.f.n(0,w,v.e.e)
v.E(y)
return new D.B(v,y,v.r,[A.fD])},
q:function(){this.f.i()},
v:function(){this.f.j()}}
A.km.prototype={}
E.KQ.prototype={
p:function(){var y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4,b5,b6,b7,b8,b9,c0,c1,c2,c3,c4,c5=this,c6=null,c7="h2",c8="mdc-card__media mdc-card__media--16-9 demo-card__media",c9="demo-card__primary",d0="demo-card__title",d1="Our Changing Planet",d2="demo-card__subtitle",d3="by Kurt Wagner",d4="demo-card__secondary",d5="Visit ten places on our planet that are undergoing the biggest changes today.",d6="mdc-card__actions",d7="mdc-card__action-buttons",d8="Bookmark",d9="mdc-card__action-icons",e0="icon",e1="favorite_border",e2="more_vert",e3=c5.a0(),e4=document,e5=T.d(e4,e3,"section")
c5.l(e5)
y=T.d(e4,e5,c7)
c5.l(y)
T.b(y,"Outlined")
x=T.r(e4,e5)
c5.A(x,"mdc-card mdc-card--outlined demo-size")
c5.h(x)
w=T.r(e4,x)
c5.A(w,c8)
c5.h(w)
...
c5.go=d
c5.fy.J(d)
c5.dy.n(0,c5.fx,H.a([H.a([a1],m)],j))
d=U.U(c5,23)
c5.id=d
a2=d.a
g.appendChild(a2)
...
c5.k4=d
c5.k3.J(d)
c5.id.n(0,c5.k2,H.a([H.a([a3],m)],j))
a4=T.d(e4,e3,"section")
c5.l(a4)
a5=T.d(e4,a4,c7)
c5.l(a5)
T.b(a5,"Elevated")
a6=T.r(e4,a4)
c5.A(a6,"mdc-card demo-size")
c5.h(a6)
a7=T.r(e4,a6)
c5.A(a7,c8)
c5.h(a7)
...
c5.a7=p
c5.a9.J(p)
c5.I.n(0,c5.a3,H.a([H.a([c4],m)],j))
c5.ae()},
N:function(d,e,f){var y=this
if(14<=e&&e<=15){if(d===C.p)return y.r
if(d===C.q||d===C.m||d===C.d)return y.x}if(16<=e&&e<=17){if(d===C.p)return y.z
if(d===C.q||d===C.m||d===C.d)return y.Q}if(19<=e&&e<=20){if(d===C.p)return y.cx
if(d===C.q||d===C.m||d===C.d)return y.cy}if(21<=e&&e<=22){if(d===C.p)return y.fr
if(d===C.q||d===C.m||d===C.d)return y.fx}if(23<=e&&e<=24){if(d===C.p)return y.k1
if(d===C.q||d===C.m||d===C.d)return y.k2}if(39<=e&&e<=40){if(d===C.p)return y.r2
if(d===C.q||d===C.m||d===C.d)return y.rx}if(41<=e&&e<=42){if(d===C.p)return y.x1
if(d===C.q||d===C.m||d===C.d)return y.x2}if(44<=e&&e<=45){if(d===C.p)return y.y2
if(d===C.q||d===C.m||d===C.d)return y.Y}if(46<=e&&e<=47){if(d===C.p)return y.Z
if(d===C.q||d===C.m||d===C.d)return y.a1}if(48<=e&&e<=49){if(d===C.p)return y.S
if(d===C.q||d===C.m||d===C.d)return y.a3}return f},
q:function(){var y,x=this,w="favorite_border",v="more_vert",u=x.e.cx===0
if(u){x.dx.saa(0,w)
y=!0}else y=!1
if(y)x.db.e.st(1)
if(u){x.go.saa(0,"share")
y=!0}else y=!1
if(y)x.fy.e.st(1)
if(u){x.k4.saa(0,v)
y=!0}else y=!1
...
y.a9.j()}}
E.Sj.prototype={
p:function(){var y,x,w=this,v=new E.KQ(w,S.h(3,C.i,0)),u=$.a5j
if(u==null)u=$.a5j=O.O($.azS,null)
v.c=u
y=document.createElement("material-card-example")
v.a=y
w.f=v
x=new A.km()
w.r=x
