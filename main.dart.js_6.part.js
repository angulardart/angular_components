...
cT:function(d,e){var x,w=new Q.v6(E.T(d,e,1)),v=$.a8B
if(v==null)v=$.a8B=O.a1($.aEf,null)
w.b=v
x=document.createElement("material-toggle")
w.c=x
w.O(x,"themeable")
return w},
aLt:function(d,e){return new Q.Jv(N.Q(),E.A(d,e,y.w))},
aLu:function(){return new Q.Jw(new G.S())},
oM:function(){if($.ade)return
$.ade=!0
$.V.w(0,C.mG,new D.l("material-toggle",Q.aAW(),y.k))
E.G()
V.hH()
K.dD()},
...
_.c=_.b=_.a=null
_.d=d}},D={
cQ:function(d,e){return new D.is(d,new P.b7(null,null,y.c))},
...
d.preventDefault()
d.stopPropagation()},
iU:function(d){if(d.keyCode===13||Z.jB(d)){this.lV()
d.preventDefault()
d.stopPropagation()}},
bj:function(){var x=this.c
if(x==null)return
x.setAttribute("aria-pressed",H.C(this.e))},
...
if(x!=null)x.am()}}
Q.v6.prototype={
q:function(){var x,w,v,u=this,t="animated",s=u.a,r=u.a2(),q=document,p=T.v(q,r)
u.dx=p
u.C(p,"material-toggle")
T.c(u.dx,"role","button")
u.h(u.dx)
p=u.e=new V.u(1,0,u,T.M(u.dx))
u.f=new K.L(new D.z(p,Q.aAV()),p)
x=T.v(q,u.dx)
u.C(x,"tgl-container")
u.h(x)
p=T.v(q,x)
...
u.br(u.fx,0)
p=u.dx
v=y.B;(p&&C.w).T(p,"blur",u.v(u.gUX(),v,v))
...
o.y=v}u=m.d
l=o.z
if(l!=u){T.c(o.dx,"aria-disabled",O.b9(u))
o.z=u}t=m.gfv()
if(t==null)t=""
l=o.Q
...
o.Q=t}s=m.y
l=o.ch
if(l!==s){T.c(o.dy,n,O.b9(s))
o.ch=s}r=m.e
l=o.cx
if(l!=r){T.ae(o.fr,"under-checked",r)
o.cx=r}q=m.z
l=o.cy
if(l!==q){T.ae(o.fr,"under-focus",q)
o.cy=q}p=m.y
l=o.db
if(l!==p){T.c(o.fx,n,O.b9(p))
o.db=p}},
G:function(){this.e.I()},
...
this.b.a5(x)}}
Q.Jw.prototype={
q:function(){var x=this,w=x.b=Q.cT(x,0),v=w.c
x.a=D.cQ(w,null)
x.F(v)},
