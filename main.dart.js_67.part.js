...
RP:function RP(){},
RQ:function RQ(){},
RR:function RR(d){this.a=d}},Z={
pK:function(d,e){return new Z.jA((e==null?new R.eN(R.fU()):e).ec(),new P.N(null,null,y.W),d)},
...
_.d=d},
Jl:function Jl(d){this.c=this.b=null
this.a=d},
Jm:function Jm(d){this.c=this.b=null
this.a=d},
...
_.a=l},
Fe:function Fe(){}}
a.setFunctionNamesIfNecessary([Y,R,K,V,M,Q,D,Z,O,A,T,L,N,U,X,B,S,F])
C=c[0]
H=c[1]
J=c[2]
P=c[3]
...
Q.j8.prototype={
slb:function(d){var x=this
if(x.c!=d){x.c=d
x.jg()
x.b.am()}},
JI:function(d){var x,w=this,v=w.c
if(d==v)return
x=new R.o0(v,d)
w.r.R(0,x)
if(x.e)return
...
x.C(t,"navi-bar")
T.c(x.Q,"focusList","")
T.c(x.Q,"ignoreUpAndDown","")
T.c(x.Q,"loop","")
T.c(x.Q,"role","tablist")
x.h(x.Q)
t=x.d
t=N.ij(t.a.n(C.f,t.b),"tablist","")
x.f=new K.fl(t)
t=T.u(u,x.Q)
x.ch=t
x.C(t,"tab-indicator")
...
if(w!=v){w=u.ch.style
w.toString
C.x.bV(w,C.x.bE(w,"transform"),v,null)
u.y=v}},
G:function(){this.r.I()
this.f.a.d.H()}}
Y.mT.prototype={
...
u=v.d.b
x=y.p
w=new P.e(u,H.m(u).i("e<1>")).D(v.v(v.gM3(),x,x))
v.aD(H.a([v.y],y.M),H.a([w],y.a))},
P:function(d,e,f){if(d===C.M&&0===e)return this.c.a
return f},
A:function(){var x,w,v,u,t,s,r=this,q=r.a,p=q.a,o=q.ch===0
q=q.f
x=q.E(0,"index")
w=q.E(0,"$implicit")
if(o){r.d.f="tab"
...
r.e=q}s=""+(p.c==x)
q=r.f
if(q!==s){T.Q(r.y,"aria-selected",s)
r.f=s}r.c.b4(r.b,r.y)
r.b.B(o)
r.b.j()},
bZ:function(){this.a.c.e=!0},
G:function(){this.b.k()},
M4:function(d){var x=this.a
...
this.e.J()},
G:function(){this.e.I()},
B:function(d){var x,w,v,u=this,t=u.a,s=t.e,r=u.r
if(r!==s){T.b2(u.c,"material-tab",s)
u.r=s}r=t.b
x="panel-"+r
w=u.x
if(w!==x){T.Q(u.c,"id",x)
u.x=x}v="tab-"+r
r=u.y
if(r!==v){T.Q(u.c,"aria-labelledby",v)
u.y=v}}}
Z.Ji.prototype={
...
x.F(w)}}
Z.Jj.prototype={
q:function(){var x,w=this,v=Z.qn(w,0)
w.b=v
x=v.c
...
this.b.j()}}
D.jB.prototype={
slb:function(d){if(this.x!=null)this.XR(d,!0)
else this.r=d},
swi:function(d){var x=this,w=x.x
x.c=w!=null?w[x.r]:null
x.x=d
if(x.b)x.mN()},
mN:function(){var x,w=this,v=w.x
v.toString
x=H.bv(v).i("bj<1,t*>")
w.y=P.bM(new H.bj(v,new D.RP(),x),!0,x.i("cr.E"))
x=w.x
x.toString
v=H.bv(x).i("bj<1,t*>")
w.z=P.bM(new H.bj(x,new D.RQ(),v),!0,v.i("cr.E"))
P.d8(new D.RR(w))},
XR:function(d,e){var x=this,w=x.x[x.r]
if(w!=null){w.e=!1
w.c.R(0,!1)}x.r=d
w=x.x[d]
w.e=!0
...
x.a.am()
x.x[x.r].bK(0)},
vX:function(d){this.d.R(0,d)},
w5:function(d){this.slb(d.c)
this.e.R(0,d)}}
X.CJ.prototype={
q:function(){var x,w,v,u=this,t=u.a,s=u.a2(),r=Y.BM(u,0)
u.e=r
x=r.c
s.appendChild(x)
u.h(x)
...
r=u.f.r
w=y.o
v=new P.e(r,H.m(r).i("e<1>")).D(u.v(t.gvW(),w,w))
r=u.f.x
u.bo(H.a([v,new P.e(r,H.m(r).i("e<1>")).D(u.v(t.gw4(),w,w))],y.a))},
A:function(){var x,w,v,u=this,t=u.a,s=u.d.f,r=t.z,q=u.r
if(q==null?r!=null:q!==r){u.r=u.f.z=r
x=!0}else x=!1
w=t.r
q=u.x
if(q!=w){u.f.slb(w)
...
F.Fe.prototype={}
S.Do.prototype={
q:function(){var x,w,v,u,t=this,s=t.a,r=t.a2(),q=T.u(document,r)
t.C(q,"content")
t.h(q)
q.appendChild(t.e.b)
x=L.qk(t,2)
...
x=y.L
v=J.aM(r)
v.T(r,"click",t.v(s.gcn(),x,y.P))
v.T(r,"keypress",t.v(s.gcd(),x,y.S))
v.T(r,"mousedown",t.v(s.gw1(s),x,x))
v.T(r,"mouseup",t.v(s.gw2(s),x,x))
u=y.p
v.T(r,"focus",t.v(s.gc9(s),x,u))
v.T(r,"blur",t.v(s.gdG(s),x,u))},
A:function(){var x=this.a,w=x.bJ$
if(w==null)w=""
this.e.a5(w)
this.f.j()},
G:function(){this.f.k()
this.r.S()},
B:function(d){var x,w,v,u,t,s,r=this,q=r.a,p=q.gj2(q),o=r.x
if(o!=p){T.Q(r.c,"tabindex",p)
r.x=p}x=q.f
o=r.y
if(o!=x){T.Q(r.c,"role",x)
r.y=x}w=H.B(q.r)
o=r.z
if(o!==w){T.Q(r.c,"aria-disabled",w)
r.z=w}v=q.r
o=r.Q
if(o!=v){T.b2(r.c,"is-disabled",v)
r.Q=v}u=q.Q
o=r.ch
if(o!==u){T.b2(r.c,"focus",u)
r.ch=u}t=q.k3||q.cx
o=r.cx
if(o!==t){T.b2(r.c,"active",t)
r.cx=t}s=q.r?"":null
o=r.cy
...
T.b(x,"        ")
T.d(document,x,"p").appendChild(this.e.b)
T.b(x,"\n        ")
this.bq(x,0)},
...
B.hH.prototype={}
N.CH.prototype={
gmA:function(){var x=this.r
return x==null?this.r=document:x},
gyA:function(){var x=this.y
return x==null?this.y=window:x},
gmB:function(){var x,w=this,v=w.z
if(v==null){v=w.d
x=v.a
v=v.b
v=T.bx(x.l(C.b,v),x.l(C.D,v),x.n(C.f,v),w.gyA())
w.z=v}return v},
gyx:function(){var x,w=this,v=w.Q
if(v==null){v=w.d
v=v.a.n(C.U,v.b)
x=w.gmB()
v=w.Q=new O.bh(v,x)}return v},
gql:function(){var x=this,w=x.ch
return w==null?x.ch=new K.bi(x.gmA(),x.gmB(),P.bu(null,y.f)):w},
gLW:function(){var x=this.cx
if(x==null){x=this.d
x=T.bB(x.a.n(C.f,x.b))
this.cx=x}return x},
gqm:function(){var x=this.cy
if(x==null){x=this.d
x=G.bF(x.a.l(C.t,x.b))
this.cy=x}return x},
gyC:function(){var x=this,w=x.db
if(w==null){w=x.d
w=G.bI(x.gmA(),w.a.l(C.u,w.b))
x.db=w}return w},
gyD:function(){var x=this,w=x.dx
if(w==null){w=x.d
w=G.bz(x.gqm(),x.gyC(),w.a.l(C.r,w.b))
x.dx=w}return w},
gqn:function(){var x=this.dy
return x==null?this.dy=!0:x},
gyE:function(){var x=this.fr
return x==null?this.fr=!0:x},
gyz:function(){var x=this.fy
if(x==null){x=this.gmA()
x=this.fy=new R.bk(x.querySelector("head"),x)}return x},
gyB:function(){var x=this.go
return x==null?this.go=X.bE():x},
gyy:function(){var x=this,w=x.id
return w==null?x.id=K.bD(x.gyz(),x.gyD(),x.gqm(),x.gql(),x.gmB(),x.gyx(),x.gqn(),x.gyE(),x.gyB()):w},
gLX:function(){var x,w,v,u,t=this,s=t.k1
if(s==null){s=t.d
x=s.a
s=s.b
w=x.n(C.f,s)
...
if(d===C.V){x=w.x
return x==null?w.x=document:x}if(d===C.J)return w.gyA()
if(d===C.b)return w.gmB()
if(d===C.P)return w.gyx()
if(d===C.N)return w.gql()
if(d===C.a_)return w.gLW()
if(d===C.t)return w.gqm()
if(d===C.u)return w.gyC()
if(d===C.r)return w.gyD()
if(d===C.T)return w.gqn()
if(d===C.F)return w.gyE()
if(d===C.G){x=w.fx
return x==null?w.fx=C.Y:x}if(d===C.R)return w.gyz()
if(d===C.E)return w.gyB()
if(d===C.Q)return w.gyy()
if(d===C.k)return w.gLX()
if(d===C.H){x=w.k2
return x==null?w.k2=C.Z:x}if(d===C.v){x=w.k3
return x==null?w.k3=new K.bp(w.gql()):x}}return f},
...
X.lc.prototype={}
L.CK.prototype={
q:function(){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3=this,a4="tab-panel",a5="themeable",a6="label",a7="eager tab",a8=a3.a2(),a9=document,b0=T.d(a9,a8,"section")
a3.m(b0)
x=T.d(a9,b0,"h2")
a3.m(x)
...
s=Z.pK(u,t.l(C.a2,w))
a3.x=s
r=T.n("Eager Content of Tab 1")
q=y.l
p=y.M
a3.r.u(s,H.a([H.a([r],q)],p))
s=Z.qn(a3,6)
a3.y=s
o=s.c
T.c(o,a6,"tab2")
...
a3.h(n)
s=new U.iB(a7)
P.i6('Named Component "eager tab" instantiated')
a3.ch=s
m=T.n("Eager Tab 2 content.")
a3.Q.u(s,H.a([H.a([m],q)],p))
s=y.O
a3.y.u(a3.z,H.a([H.a([n],s)],p))
l=Z.qn(a3,9)
a3.cx=l
k=l.c
T.c(k,a6,"tab3")
...
a3.e.u(a3.f,H.a([H.a([u,o,k,i],s)],p))
g=T.d(a9,a8,"section")
a3.C(g,"margin")
a3.m(g)
f=T.d(a9,g,"h2")
...
j=Z.pK(d,t.l(C.a2,w))
a3.k2=j
a0=T.n("Content of tab 1")
a3.k1.u(j,H.a([H.a([a0],q)],p))
j=Z.qn(a3,19)
a3.k3=j
a1=j.c
T.c(a1,a6,"tab2")
a3.h(a1)
w=Z.pK(a1,t.l(C.a2,w))
a3.k4=w
a2=T.n("Content of tab 2")
...
if((!w||d===C.p)&&11<=e&&e<=12)return x.fr
if((!w||d===C.p)&&17<=e&&e<=18)return x.k2
if((!w||d===C.p)&&19<=e&&e<=20)return x.k4
return f},
...
u.h(w)
x=new U.iB(t)
P.i6('Named Component "deferred tab 3" instantiated')
u.c=x
v=T.n("Lazy Tab 3 Content")
u.b.u(x,H.a([H.a([v],y.l)],y.M))
u.F(s)},
A:function(){this.b.j()},
G:function(){this.b.k()}}
L.Jm.prototype={
...
u=new V.h8()
v.c=u
w=T.n("Delayed Tab 4 Content")
v.b.u(u,H.a([H.a([w],y.l)],y.M))
v.F(x)},
...
vX:function(d){if(this.c)d.e=!0}}
S.v0.prototype={
q:function(){var x,w,v,u,t,s,r,q,p,o,n,m=this,l="Active Tab Index ",k=m.a,j=m.a2(),i=document,h=T.d(i,j,"section")
T.b(T.d(i,h,"h2"),"A tab strip with 3 tabs")
x=Y.BM(m,3)
m.r=x
h.appendChild(x.c)
x=m.d
...
t=v.c
h.appendChild(t)
T.c(t,"label","Stop Tab Change")
v=D.cG(m.y,null)
m.z=v
m.y.u(v,H.a([C.a],y.M))
s=T.d(i,j,"section")
m.C(s,"margin")
T.b(T.d(i,s,"h2"),"A tab strip with set width")
v=Y.BM(m,11)
m.Q=v
r=v.c
s.appendChild(r)
...
x=m.x.r
w=y.o
p=new P.e(x,H.m(x).i("e<1>")).D(m.v(k.gvW(),w,w))
x=m.x.x
o=new P.e(x,H.m(x).i("e<1>")).D(m.v(k.gw4(),w,w))
x=m.z.f
v=y.b
n=new P.e(x,H.m(x).i("e<1>")).D(m.v(m.gUy(),v,v))
v=m.ch.x
m.bo(H.a([p,o,n,new P.e(v,H.m(v).i("e<1>")).D(m.v(m.gUA(),w,w))],y.a))},
P:function(d,e,f){if(d===C.c&&7===e)return this.z
return f},
...
gKe:function(){var x=this,w=x.f
if(w==null){w=T.bx(x.l(C.b,null),x.l(C.D,null),x.n(C.f,null),x.gxo())
x.f=w}return w},
...
K.ld.prototype={}
O.CL.prototype={
q:function(){var x,w,v,u,t=this,s=t.a2(),r=document,q=T.d(r,s,"section")
t.m(q)
x=T.d(r,q,"h2")
t.m(x)
T.b(x,"A tab strip with 4 tabs : Custom colors and width")
w=Y.BM(t,3)
t.e=w
v=w.c
q.appendChild(v)
T.c(v,"style","width: 480px;")
t.h(v)
w=t.d
u=w.a
w=w.b
...
G:function(){this.e.k()}}
O.Jp.prototype={
gCI:function(){var x=this.e
return x==null?this.e=document:x},
gCJ:function(){var x=this.r
...
$.aEc=[$.aFn]
$.aEd=[$.aFm]})()}
$__dart_deferred_initializers__["TTK3ghQ9WGOBbhOCZUIlqY3LKUY="] = $__dart_deferred_initializers__.current
