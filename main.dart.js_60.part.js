...
O.hB.prototype={}
M.Ct.prototype={
gnt:function(){var x=this.r
return x==null?this.r=document:x},
gC7:function(){var x=this.y
return x==null?this.y=window:x},
gnu:function(){var x,w=this,v=w.z
if(v==null){v=w.d
x=v.a
v=v.b
v=T.bx(x.l(C.b,v),x.l(C.D,v),x.n(C.f,v),w.gC7())
w.z=v}return v},
gC4:function(){var x,w=this,v=w.Q
if(v==null){v=w.d
v=v.a.n(C.U,v.b)
x=w.gnu()
v=w.Q=new O.bh(v,x)}return v},
gt4:function(){var x=this,w=x.ch
return w==null?x.ch=new K.bi(x.gnt(),x.gnu(),P.bu(null,y.C)):w},
gTK:function(){var x=this.cx
if(x==null){x=this.d
...
this.cy=x}return x},
gC9:function(){var x=this,w=x.db
if(w==null){w=x.d
w=G.bI(x.gnt(),w.a.l(C.u,w.b))
x.db=w}return w},
gCa:function(){var x=this,w=x.dx
if(w==null){w=x.d
w=G.bz(x.gt5(),x.gC9(),w.a.l(C.r,w.b))
x.dx=w}return w},
gt6:function(){var x=this.dy
return x==null?this.dy=!0:x},
gCb:function(){var x=this.fr
return x==null?this.fr=!0:x},
gC6:function(){var x=this.fy
if(x==null){x=this.gnt()
x=this.fy=new R.bk(x.querySelector("head"),x)}return x},
gC8:function(){var x=this.go
return x==null?this.go=X.bE():x},
gC5:function(){var x=this,w=x.id
return w==null?x.id=K.bD(x.gC6(),x.gCa(),x.gt5(),x.gt4(),x.gnu(),x.gC4(),x.gt6(),x.gCb(),x.gC8()):w},
gTL:function(){var x,w,v,u,t=this,s=t.k1
if(s==null){s=t.d
x=s.a
s=s.b
w=x.n(C.f,s)
...
if(d===C.V){x=w.x
return x==null?w.x=document:x}if(d===C.J)return w.gC7()
if(d===C.b)return w.gnu()
if(d===C.P)return w.gC4()
if(d===C.N)return w.gt4()
if(d===C.a_)return w.gTK()
if(d===C.t)return w.gt5()
if(d===C.u)return w.gC9()
if(d===C.r)return w.gCa()
if(d===C.T)return w.gt6()
if(d===C.F)return w.gCb()
if(d===C.G){x=w.fx
return x==null?w.fx=C.Y:x}if(d===C.R)return w.gC6()
if(d===C.E)return w.gC8()
if(d===C.Q)return w.gC5()
if(d===C.k)return w.gTL()
if(d===C.H){x=w.k2
return x==null?w.k2=C.Z:x}if(d===C.v){x=w.k3
return x==null?w.k3=new K.bp(w.gt4()):x}}return f},
...
B.l5.prototype={}
B.Cv.prototype={
q:function(){var x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g=this,f=null,e="h2",d="section",a0="margin",a1="loading",a2=g.a2(),a3=document,a4=T.u(a3,a2)
g.h(a4)
x=T.d(a3,a4,e)
g.m(x)
T.b(x,"Active progress only")
w=T.d(a3,a4,d)
g.C(w,a0)
g.m(w)
v=S.o5(g,4)
...
w.appendChild(u)
g.h(u)
v=new X.eG(g.e,u,!0,T.aR(a1,f,f,f,f))
g.f=v
g.e.K(0,v)
t=T.d(a3,a4,e)
g.m(t)
T.b(t,"Active and secondary progress")
s=T.d(a3,a4,d)
g.C(s,a0)
g.m(s)
v=S.o5(g,8)
...
s.appendChild(r)
g.h(r)
v=new X.eG(g.r,r,!0,T.aR(a1,f,f,f,f))
g.x=v
g.r.K(0,v)
v=S.o5(g,9)
g.y=v
...
s.appendChild(q)
g.h(q)
v=new X.eG(g.y,q,!0,T.aR(a1,f,f,f,f))
g.z=v
g.y.K(0,v)
p=T.d(a3,a4,e)
g.m(p)
...
o.appendChild(n)
g.h(n)
v=new X.eG(g.Q,n,!0,T.aR(a1,f,f,f,f))
g.ch=v
g.Q.K(0,v)
m=T.d(a3,a4,d)
g.C(m,"custom-theme")
...
j=T.d(a3,k,e)
g.m(j)
T.b(j,"material-progress-theme($indeterminate-color: $mat-red-100, $active-color: $mat-red-500, $secondary-color: $mat-red-200)")
v=S.o5(g,20)
g.cx=v
i=v.c
k.appendChild(i)
g.h(i)
v=new X.eG(g.cx,i,!0,T.aR(a1,f,f,f,f))
g.cy=v
g.cx.K(0,v)
v=S.o5(g,21)
g.db=v
...
k.appendChild(h)
g.h(h)
v=new X.eG(g.db,h,!0,T.aR(a1,f,f,f,f))
g.dx=v
g.db.K(0,v)},
